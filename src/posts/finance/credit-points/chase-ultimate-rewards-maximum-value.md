---
title: "Chase Ultimate Rewards: How to Maximize Every Point"
description: "Chase Ultimate Rewards is the most flexible points currency in travel. Here's how to earn more, transfer smarter, and never leave value on the table."
date: 2026-05-17
...
<div class="info-box">
  <div class="info-box-title">Chase UR Point Values</div>
  <p><strong>Chase Travel portal:</strong> 1.25 cents/pt (Preferred) or 1.5 cents/pt (Reserve) · <strong>Transfer to Hyatt:</strong> typically 1.7-4.5 cents/pt · <strong>Transfer to United:</strong> typically 1.4-2.2 cents/pt · <strong>Transfer to Air France Flying Blue:</strong> typically 1.3-2.0 cents/pt</p>
</div>
...
The math at a Category 6 property like the <a href="/posts/travel/hotel-reviews/andaz-maui-review/">Andaz Maui at Wailea</a> illustrates why: 22,000 Hyatt points (transferred from 22,000 Chase UR) books a room retailing at $800-1,000/night. That's 3.6-4.5 cents per point — more than double what the Chase Travel portal delivers and more than triple what most airline redemptions achieve.
...
<div class="pro-tip">
  ...
  <div>
    <div class="pro-tip-title">The Transfer Rule</div>
    <p>Never transfer Chase UR points to a partner speculatively. Points are infinitely flexible in Chase's ecosystem. Confirm award availability first, transfer second. Transfers are instant but irreversible — you cannot transfer back.</p>
  </div>
</div>
...
**Andaz Maui — 4 nights, Category 6:**
22,000 pts/night x 4 = 88,000 UR points transferred to Hyatt. Cash equivalent: $3,200-4,000. Value: approximately 3.6-4.5 cents per point. See our <a href="/posts/travel/hotel-reviews/andaz-maui-review/">full Andaz Maui review</a> for the complete points breakdown.
...
**Economy flight, New York to Miami:**
18,000 United miles transferred from 18,000 Chase UR. Cash equivalent: $250. Value: 1.4 cents per point. In this case, the Chase Travel portal at 1.5 cents (Sapphire Reserve) actually beats the transfer. Pay the portal rate, save the miles for a better redemption.

For more on how to plan around affordable destinations, our guide to <a href="/posts/travel/europe/affordable-luxury-destinations-2026/">5 affordable luxury destinations in 2026</a> covers places where your Chase points go furthest on both flights and hotels.
...
<div class="checklist-wrap" style="background:var(--cream);border:1px solid var(--border);border-radius:2px;padding:1.75rem;margin:2rem 0;">
  <h3 style="margin-top:0;font-size:1rem;font-weight:600;color:var(--navy);margin-bottom:1rem;font-family:var(--font-body);">Chase Ultimate Rewards — Getting Started</h3>
  <div class="progress-text" id="progress-text-ch">0 of 8 completed</div>
  <div class="progress-bar" style="height:5px;background:var(--border);border-radius:3px;margin-bottom:1.25rem;overflow:hidden;"><div class="progress-fill" id="progress-fill-ch" style="height:100%;background:var(--navy);border-radius:3px;transition:width .4s ease;width:0%;"></div></div>
  <div id="checklist-ch">
    <div class="checklist-item" style="display:flex;align-items:flex-start;gap:.75rem;padding:.75rem 0;border-bottom:1px solid var(--border);"><input type="checkbox" id="cch-1" onchange="updateProgressCH()" style="width:18px;height:18px;accent-color:var(--navy);cursor:pointer;margin-top:2px;flex-shrink:0;"><label for="cch-1" style="cursor:pointer;font-size:15px;color:var(--slate);line-height:1.55;">Open a World of Hyatt account before your first transfer — you need the account number ready</label></div>
    <div class="checklist-item" style="display:flex;align-items:flex-start;gap:.75rem;padding:.75rem 0;border-bottom:1px solid var(--border);"><input type="checkbox" id="cch-2" onchange="updateProgressCH()" style="width:18px;height:18px;accent-color:var(--navy);cursor:pointer;margin-top:2px;flex-shrink:0;"><label for="cch-2" style="cursor:pointer;font-size:15px;color:var(--slate);line-height:1.55;">Combine all your Chase UR points into one primary Sapphire account for transfer capability</label></div>
    <div class="checklist-item" style="display:flex;align-items:flex-start;gap:.75rem;padding:.75rem 0;border-bottom:1px solid var(--border);"><input type="checkbox" id="cch-3" onchange="updateProgressCH()" style="width:18px;height:18px;accent-color:var(--navy);cursor:pointer;margin-top:2px;flex-shrink:0;"><label for="cch-3" style="cursor:pointer;font-size:15px;color:var(--slate);line-height:1.55;">Assign each spending category to the card that earns most — don't put everything on one card</label></div>
    <div class="checklist-item" style="display:flex;align-items:flex-start;gap:.75rem;padding:.75rem 0;border-bottom:1px solid var(--border);"><input type="checkbox" id="cch-4" onchange="updateProgressCH()" style="width:18px;height:18px;accent-color:var(--navy);cursor:pointer;margin-top:2px;flex-shrink:0;"><label for="cch-4" style="cursor:pointer;font-size:15px;color:var(--slate);line-height:1.55;">Confirm award availability before transferring — check Hyatt.com or the airline site first</label></div>
    <div class="checklist-item" style="display:flex;align-items:flex-start;gap:.75rem;padding:.75rem 0;border-bottom:1px solid var(--border);"><input type="checkbox" id="cch-5" onchange="updateProgressCH()" style="width:18px;height:18px;accent-color:var(--navy);cursor:pointer;margin-top:2px;flex-shrink:0;"><label for="cch-5" style="cursor:pointer;font-size:15px;color:var(--slate);line-height:1.55;">Never redeem UR for Amazon, gift cards, or statement credits — always aim for 1.7+ cents per point</label></div>
    <div class="checklist-item" style="display:flex;align-items:flex-start;gap:.75rem;padding:.75rem 0;border-bottom:1px solid var(--border);"><input type="checkbox" id="cch-6" onchange="updateProgressCH()" style="width:18px;height:18px;accent-color:var(--navy);cursor:pointer;margin-top:2px;flex-shrink:0;"><label for="cch-6" style="cursor:pointer;font-size:15px;color:var(--slate);line-height:1.55;">Check the Chase shopping portal before any online purchase for bonus earning opportunities</label></div>
    <div class="checklist-item" style="display:flex;align-items:flex-start;gap:.75rem;padding:.75rem 0;border-bottom:1px solid var(--border);"><input type="checkbox" id="cch-7" onchange="updateProgressCH()" style="width:18px;height:18px;accent-color:var(--navy);cursor:pointer;margin-top:2px;flex-shrink:0;"><label for="cch-7" style="cursor:pointer;font-size:15px;color:var(--slate);line-height:1.55;">Track your 5/24 status before applying for any new Chase card</label></div>
    <div class="checklist-item" style="display:flex;align-items:flex-start;gap:.75rem;padding:.75rem 0;"><input type="checkbox" id="cch-8" onchange="updateProgressCH()" style="width:18px;height:18px;accent-color:var(--navy);cursor:pointer;margin-top:2px;flex-shrink:0;"><label for="cch-8" style="cursor:pointer;font-size:15px;color:var(--slate);line-height:1.55;">Set up Flying Blue, United MileagePlus, and British Airways accounts — you need them before transfers</label></div>
  </div>
</div>
...
<script>
function updateProgressCH(){
  var checks=document.querySelectorAll('#checklist-ch input[type="checkbox"]');
  var done=Array.from(checks).filter(function(c){return c.checked;}).length;
  var total=checks.length;
  document.getElementById('progress-fill-ch').style.width=(done/total*100)+'%';
  document.getElementById('progress-text-ch').textContent=done+' of '+total+' completed';
